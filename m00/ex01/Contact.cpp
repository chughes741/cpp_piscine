...
std::string Contact::getFirstName() { return (first_name_); }

// Getter for last_name_
std::string Contact::getLastName() { return (last_name_); }

// Getter for nickname_
std::string Contact::getNickname() { return (nickname_); }

// Getter for phone_number_
std::string Contact::getPhoneNumber() { return (phone_number_); }

// Getter for phone_number_
std::string Contact::getDarkestSecret() { return (darkest_secret_); }
